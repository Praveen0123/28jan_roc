...
const rocCalculatorService: string = `https://api-roc-calculator.returnon.college/`;
...
export const CONFIG =
{
  ...
  AUTH0:
  {
    ...
    AUDIENCE: 'https://roc-modeling.us.auth0.com/api/v2/',
    API_USERS: 'https://roc-modeling.us.auth0.com/api/v2/users',
    API_TOKEN: 'https://roc-modeling.us.auth0.com/oauth/token'
  },
  SEND_GRID:
  {
    API_KEY: process.env.SENDGRID_API,
    FROM_EMAIL_ADDRESS: 'mail@returnon.college'
  },
  POSTGRES:
  {
