...
export class EducationLevelEnum extends Enumeration
{
  ...
  public static readonly EleventhGradeStudent = new EducationLevelEnum(-2, '11th Grade', 1, 2, 'an');
  public static readonly TwelfthDegreeStudent = new EducationLevelEnum(-1, '12th Grade', 1, 3);
  public static readonly HighSchoolGraduate = new EducationLevelEnum(0, 'High School Diploma', 2, 4);
  public static readonly AssociatesDegree = new EducationLevelEnum(1, "Associate's Degree", 3, 5, 'an');
  ...
  public indefiniteArticle: string;
  ...
  static getEducationLevelGoalOptions(): EducationLevelEnum[]
  {
    try
    {
      if (EducationLevelEnum.Instances)
      {
        const instances = EducationLevelEnum.Instances.filter((item: EducationLevelEnum) => item._educationLevelGroupId >= 2);
